...
extern EXPORT_TO_CLEAN void
WinSetObjectFocus (int x1, int y1, int x2, int y2, int maxxv, int maxyv,
                   OS ios, int *result, OS *oos)
{
...
extern EXPORT_TO_CLEAN void
WinSetObjectRec (int id, int objtype, int subtype, BOOL active,
...
extern EXPORT_TO_CLEAN void
WinGetObjectRec (int id, OS ios, int *objtype, int *subtype, BOOL *active,
                 int *xpos, int *ypos, int *xsize, int *ysize,
                 int *xoffset, int *yoffset, int *spriteid,
                 int *displayoptions, int *ownbounds, int *bouncebounds,
                 int *collidebounds, int *forgetx, int *forgety, int *time,
...
extern EXPORT_TO_CLEAN void
WinShowStatistic (int x, int y, CLEAN_STRING format, int value,
                  int r, int g, int b,
...
void WinPlayMusic (CLEAN_STRING midifile, BOOL restart, OS ios,
                   int *result, OS *oos)
{
...
extern EXPORT_TO_CLEAN
void WinInitSoundSample (int id, CLEAN_STRING name, int buffers,
                         OS ios, int *result, OS *oos)
{
    *result = GR_OK;
    if (id == -1)
...
extern EXPORT_TO_CLEAN
void WinGetBoundMap (int x, int y, OS ios,
                     int *mapvalue, int *result, OS *oos)
{
    int mappos;
...
extern EXPORT_TO_CLEAN
void WinSetBoundMap (int x, int y, int newvalue, OS ios,
                     int *result, OS *oos)
{
    int mappos;
...
/*
extern EXPORT_TO_CLEAN
void WinPlaySoundSample (int id, int volume, int pan, int freq, int delay,
                         OS ios, int *result, OS *oos)
{
